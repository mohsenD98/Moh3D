...
Pane {
    id: panel
    required property SpotLight target
    ...
    ColumnLayout {
        ...
        RowLayout {
            Slider {
                from: 0
                to: panel.target.coneAngle
                value: panel.target.innerConeAngle
                onValueChanged: panel.target.innerConeAngle = value
            }
            Label {
                text: panel.target.innerConeAngle.toFixed(1)
            }
        }
        Label {
            text: "Cone Angle"
        ...
        RowLayout {
            Slider {
                from: 0
                to: 180
                value: panel.target.coneAngle
                onValueChanged: panel.target.coneAngle = value
            }
            Label {
                text: panel.target.coneAngle.toFixed(1)
            }
        }
